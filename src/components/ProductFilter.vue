        ...
        <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
          <fieldset class="form__block">
            ...
            <label class="form__label form__label--price" for="price-first">
              <input class="form__input" id="price-first"
              type="text" name="min-price" v-model.number="currentPriceFrom">
              <span class="form__value">От</span>
            </label>
            <label class="form__label form__label--price" for="price-last">
              <input class="form__input" id="price-last"
              type="text" name="max-price" placeholder="12345" v-model.number="currentPriceTo">
          ...
          <fieldset class="form__block">
            ...
            <label class="form__label form__label--select" for="category">
              ...
              name="category" id="category" v-model.number="currentCategoryId">
            ...
            <ul class="colors">
              <li class="colors__item">
                <label class="colors__label" for="color1">
                  <input class="colors__radio sr-only" id="color1"
              ...
              <li class="colors__item">
                <label class="colors__label" for="color2">
                  <input class="colors__radio sr-only" id="color2"
                  type="radio" name="color" value="#FFBE15">
                  <span class="colors__value"
              ...
              <li class="colors__item">
                <label class="colors__label" for="color3">
                  <input class="colors__radio sr-only" id="color3"
                  type="radio" name="color" value="#939393">
                  <span class="colors__value"
              ...
              <li class="colors__item">
                <label class="colors__label" for="color4">
                  <input class="colors__radio sr-only" id="color4"
                  type="radio" name="color" value="#8BE000">
                  <span class="colors__value"
              ...
              <li class="colors__item">
                <label class="colors__label" for="color5">
                  <input class="colors__radio sr-only" id="color5"
                  type="radio" name="color" value="#FF6B00">
                  <span class="colors__value"
              ...
              <li class="colors__item">
                <label class="colors__label" for="color6">
                  <input class="colors__radio sr-only" id="color6"
                  type="radio" name="color" value="#FFF">
                  <span class="colors__value"
              ...
              <li class="colors__item">
                <label class="colors__label" for="color7">
                  <input class="colors__radio sr-only" id="color7"
                  type="radio" name="color" value="#000">
                  <span class="colors__value"
            ...
            <ul class="check-list">
              <li class="check-list__item">
                <label class="check-list__label" for="ram8">
                  <input class="check-list__check sr-only" id="ram8"
              ...
              <li class="check-list__item">
                <label class="check-list__label" for="ram16">
                  <input class="check-list__check sr-only" id="ram16"
              ...
              <li class="check-list__item">
                <label class="check-list__label" for="ram32">
                  <input class="check-list__check sr-only" id="ram32"
              ...
              <li class="check-list__item">
                <label class="check-list__label" for="ram64">
                  <input class="check-list__check sr-only" id="ram64"
              ...
              <li class="check-list__item">
                <label class="check-list__label" for="ram128">
                  <input class="check-list__check sr-only" id="ram128"
              ...
              <li class="check-list__item">
                <label class="check-list__label" for="ram264">
                  <input class="check-list__check sr-only" id="ram264"
